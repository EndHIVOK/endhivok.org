 ...
 */
$config_directories = [
  'active' => getenv('CONFIG_ACTIVE_DIRECTORY'),
  'sync' => getenv('CONFIG_SYNC_DIRECTORY'),
];

//$config_directories['active'] = getenv('CONFIG_ACTIVE_DIRECTORY');
 ...
 * @endcode
 */
$settings['hash_salt'] = 'gBZD-t-t-mxEanAsYZUZq_lb17aY9Rsgq1waBJw-H4nSUqHOnO3awImijYDLJCn6oN9YUtYb7w';
 ...
 */
$settings['update_free_access'] = getenv('UPDATE_FREE_ACCESS');
...
$config['system.site']['mail'] = getenv('SITE_MAIL');
